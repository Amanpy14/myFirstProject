...
def register():
    ...
    for i in password:
        if i not in caps or i not in special_char:
            n=1
    if countforpswd==1:
        return render_template("fail.html", detail="Password must contain upper case and special chracter", message="Registration failed")
